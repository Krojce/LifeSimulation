...
public class TextMeshCreator {
    ...
    private static void addTexCoordinatess(List<Float> texCoordinates, double x, double y, double maxX, double maxY) {
        texCoordinates.add((float) x);
        texCoordinates.add((float) y);
        texCoordinates.add((float) x);
        texCoordinates.add((float) maxY);
        texCoordinates.add((float) maxX);
        texCoordinates.add((float) maxY);
        texCoordinates.add((float) maxX);
        texCoordinates.add((float) maxY);
        texCoordinates.add((float) maxX);
        ...
        for (Line line : lines) {
            ...
            for (Word word : line.getWords()) {
                for (Character letter : word.getCharacters()) {
                    ...
                    addTexCoordinatess(textureCoordinates, letter.getxTextureCoordinates(), letter.getyTextureCoordinates(),
